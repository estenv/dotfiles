...
import { captureBatch, captureUnindexedBatchesFromSession, groupBatchesByMode } from "./batch-capture.js";
import { summarizeBatch, summarizeBatches } from "./summarizer.js";
...
import { formatSummaryToolCallRefs, makeSummaryDetails } from "./summary-refs.js";
import type { ContextPruneConfig, CapturedBatch, IndexEntryData, PruneFrontier, FlushOptions } from "./types.js";
import {
  DEFAULT_CONFIG,
...
export default function (pi: ExtensionAPI) {
  ...
  const flushPending = async (ctx: any, options: FlushOptions = {}): Promise<FlushResult> => {
    ...
    try {
      ...
      let results: (import("./types.js").SummarizeResult | null)[];
